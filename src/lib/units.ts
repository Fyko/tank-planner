...
export function parseValueWithUnit(s: string, unitRequired = true) {
...
export function formatEIValue(x: number, options: { trim?: boolean; decimals?: number; scientific?: boolean } = {}): string {
